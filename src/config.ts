...
export const siteConfig: SiteConfig = {
	title: "浪颜博客",
	subtitle: "专注于分享网络资源和技术教程",
	siteURL: "https://www.namikao.com/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-13", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	navbarTitle: {
		...
		// 网站Logo图片路径
		logo: "assets/home/default-logo.svg",
	},
	...
	bangumi: {
		userId: "by-浪颜", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
		fetchOnDev: false, // 是否在开发环境下获取 Bangumi 数据（默认 false），获取前先执行 pnpm build 构建 json 文件
	},

	bilibili: {
		vmid: "494506799", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "官网:aevum.namikao.com", // 公告内容
	closable: true, // 允许用户关闭公告
	link: {
		enable: true, // 启用链接
		text: "官方群", // 链接文本
		url: "https://qm.qq.com/q/PVS08g56QS", // 链接 URL
		external: false, // 内部链接
	},
};
